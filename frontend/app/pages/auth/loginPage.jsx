...
const loginPage = () => {
  return (
    ...
    <div className="px-4 py-20 mx-auto max-w-7xl">
      <a href="/" title="Kutty Home Page" className="flex items-center justify-start sm:justify-center">
      ...
      <p className="mb-4 space-y-2 text-sm text-left text-gray-600 sm:text-center sm:space-y-0">
        <a href="#" className="w-full btn btn-sm btn-link sm:w-auto">Forgot password</a>
        <a href="#" className="w-full btn btn-sm btn-link sm:w-auto">Create an account</a>
      </p>
    </div>
  </section>
