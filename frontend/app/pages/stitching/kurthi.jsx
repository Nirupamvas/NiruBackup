	...
	<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
		...
		<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
			...
			<div aria-hidden="true" className="mt-10 lg:mt-0">
				<img src="https://images.pexels.com/photos/3244513/pexels-photo-3244513.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500" />
			</div>
		</div>
    ...
    <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
		...
		<div>
			<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
				...
				<div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
					<img src="https://images.pexels.com/photos/1375736/pexels-photo-1375736.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=22" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500 size-fit" />
				</div>
			</div>
		</div>
	</div>
