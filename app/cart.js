        ...
        <Wrapper>
            ...
            <div className="flex flex-col lg:flex-row gap-12 py-10">
                ...
                <div className="flex-[1]">
                    ...
                    <div className="p-5 my-5 bg-[#b6cf92] rounded-xl">
                        <div className="flex justify-between">
                            <div className="uppercase text-md md:text-lg font-medium text-black">Subtotal</div>
                            <div className="text-md md:text-lg font-medium text-black">₹30,000.00</div>
                        </div>
            ...
            {/* FOR EMPTY CART /empty-cart.jpg*/}
            <div className="flex-[2] flex flex-col items-center pb-[50px] md:mt-14">
                <Image src="/empty-cart-undraw.png" width={300} height={300} className="w-[300px] md:w-[400px]"/>
